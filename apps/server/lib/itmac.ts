...
export function verifyClientCommitment(clientCommit?: Hex, clientRand?: Hex): boolean {
...
export function makeItmacBundle(args: {
    ...
    const flip = args.provider.performCoinFlip(args.clientCommit, args.clientRand);
