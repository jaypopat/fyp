...
function transformPageTree(tree: PageTree.Folder): PageTree.Folder {
	function SvgIcon({ __html }: { __html: string }) {
		// The icon markup is generated by the docs pipeline and not user-provided
		// biome-ignore lint/security/noDangerouslySetInnerHtml: Trusted SVG from build-time source
