...
export const getModelOptions = {
	...
	weightsFile: string("weights")
		.alias("w")
		.desc("Path to weights JSON file (alternative to hash)"),
};
...
export const proveModelBiasOptions = {
	weights: string("weights")
		.required()
		.alias("w")
		.desc("Path to model weights JSON file"),
	data: string("data")
		.alias("d")
		.required()
	...
	schema: string("schema")
		.alias("s")
		.desc("Path to dataset schema JSON (optional for commit)"),
	out: string("out")
		.alias("o")
...
export const getProofStatusOptions = {
	...
	weights: positional("weights")
		.required()
		.desc("Path of the weights JSON file to get associated proof"),
};

export const verifyProofOptions = {
	weights: string("weights")
		.alias("w")
		.desc("Path to weights JSON file (for weights commitment)"),
...
export const commitOptions = {
	weights: string("weights")
		.required()
		.alias("w")
		.desc("Path to model weights JSON file (for weights commitment)"),
	data: string("data")
		.required()
		.alias("d")
	...
	schema: string("schema")
		.alias("s")
		.desc("Path to dataset schema JSON (required when committing dataset)"),
	name: string("name").required().alias("n").desc("Human-readable model name"),
	description: string("description")
		.required()
		.alias("D")
