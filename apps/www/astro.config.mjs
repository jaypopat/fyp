...
export default defineConfig({
  ...
  integrations: [
    starlight({
      title: "zk-Fair Docs",
      description: "Privacy-preserving AI model fairness auditing using zero-knowledge proofs.",
      customCss: [
      ...
      sidebar: [
        ...
        { label: "Phase 1 - Certification", items: [
          ...
          { label: "Generating Proofs", slug: "docs/phase1/generating-proofs" },
          { label: "On-Chain Registration", slug: "docs/phase1/on-chain-registration" },
          { label: "IT-MAC Key Setup", slug: "docs/phase1/itmac-setup" },
        ]},

        { label: "Phase 2 - Serving", items: [
          { label: "Overview", slug: "docs/phase2/overview" },
          { label: "Provider Setup", slug: "docs/phase2/provider-setup" },
          { label: "Query Authentication", slug: "docs/phase2/query-authentication" },
          { label: "Batch Commitments", slug: "docs/phase2/batch-commitments" },
          { label: "Client Integration", slug: "docs/phase2/client-integration" },
        ]},

        { label: "Phase 3 - Auditing", items: [
          { label: "Overview", slug: "docs/phase3/overview" },
          { label: "Becoming an Auditor", slug: "docs/phase3/becoming-an-auditor" },
          { label: "Audit Triggers", slug: "docs/phase3/audit-triggers" },
          { label: "Sampling Queries", slug: "docs/phase3/sampling-queries" },
          { label: "Generating Proofs", slug: "docs/phase3/generating-proofs" },
          { label: "Submitting Results", slug: "docs/phase3/submitting-results" },
        ]},

        { label: "Smart Contracts", items: [
          ...
          { label: "Proof Verification", slug: "docs/contracts/proof-verification" },
          { label: "Contract Events", slug: "docs/contracts/events" },
        ]},

        { label: "ZK Circuits", items: [
          { label: "Circuit 1: Training", slug: "docs/circuits/training" },
          { label: "Circuit 2: Fairness Audit", slug: "docs/circuits/audit" },
          { label: "Input/Output Reference", slug: "docs/circuits/io-reference" },
          { label: "Circuit Optimization", slug: "docs/circuits/optimization" },
          { label: "Testing Circuits", slug: "docs/circuits/testing" },
        ]},

        { label: "SDK Reference", items: [
        ...
        { label: "Provider Guide", items: [
          ...
          { label: "Monitoring & Logs", slug: "docs/provider-guide/monitoring" },
        ]},

        { label: "Client Guide", items: [
          { label: "Querying Models", slug: "docs/client-guide/querying" },
          { label: "Storing Proofs", slug: "docs/client-guide/storing" },
          { label: "Verifying Commitments", slug: "docs/client-guide/verifying" },
          { label: "Challenging Audits", slug: "docs/client-guide/challenging" },
        ]},

        { label: "Auditor Guide", items: [
          { label: "Registration Process", slug: "docs/auditor-guide/registration" },
          { label: "Key Management", slug: "docs/auditor-guide/key-management" },
          { label: "Running Audits", slug: "docs/auditor-guide/running" },
          { label: "Earning Rewards", slug: "docs/auditor-guide/rewards" },
          { label: "Reputation System", slug: "docs/auditor-guide/reputation" },
        ]},

        { label: "Examples", items: [
          { label: "Adult Income Model", slug: "docs/examples/adult-income" },
          { label: "Credit Scoring Model", slug: "docs/examples/credit-scoring" },
          { label: "Loan Approval Model", slug: "docs/examples/loan-approval" },
          { label: "Custom Model Integration", slug: "docs/examples/custom-integration" },
        ]},

        { label: "Advanced Topics", items: [
          { label: "Threshold Cryptography", slug: "docs/advanced/threshold-cryptography" },
          { label: "Merkle Tree Construction", slug: "docs/advanced/merkle" },
          { label: "VRF-based Sampling", slug: "docs/advanced/vrf-sampling" },
          { label: "Gas Optimization", slug: "docs/advanced/gas-optimization" },
        ...
        { label: "Troubleshooting", items: [
          { label: "Common Errors", slug: "docs/troubleshooting/common-errors" },
          { label: "Debugging Tips", slug: "docs/troubleshooting/debugging" },
          { label: "Performance Issues", slug: "docs/troubleshooting/performance" },
        ...
        { label: "Contributing", items: [
          ...
          { label: "Testing Requirements", slug: "docs/contributing/testing" },
        ]},
